...
{
    var items = [];
    items.push({ text: '预览效果', click: preview, img: "../../lab/icons/application_view_list.png" });
    items.push({ text: '导出JSON', click: outjson, img: "../../lab/icons/printer_48.png" });
    items.push({ text: '上移', click: moveup, img: "../../lab/icons/sign_up.gif" });
    items.push({ text: '下移', click: movedown, img: "../../lab/icons/arrow_down.gif" }); 
    items.push({ text: '提交', click: onsubmit, img: "../../lab/icons/accepted_48.png" });
