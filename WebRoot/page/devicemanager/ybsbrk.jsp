	    ...
	    <div class="navline" style="margin-bottom:4px; margin-top:4px;"></div>
	         ...
	         <form name="formsearch" method="post"  id="form1">
	        	<table border="0" cellspacing="1">
						...
						<td><input type="text" id="txtDate" ltype="date" align="left"/></td>
						<td valign="middle">--</td>
						<td><input type="text" id="txtDate1" ltype="date" align="left"/></td>
						
						<td align="right" class="l-table-edit-td" style="width:120px">仪表类型：</td>
		                <td align="left" class="l-table-edit-td" >
		                	<input type="text" id="INSTRU_1TN" name = "INSTRU_1TN"/>
		                </td>
						
						<td align="right" class="l-table-edit-td" style="width:120px">物料编码：</td>
		                <td align="left" class="l-table-edit-td"  >
		                	<input type="text" id="oilName" name = "oilName" />
		                </td>
		               <td align="right" class="l-table-edit-td" style="width:120px">仪表型号：</td>
		                <td align="left" class="l-table-edit-td" >
		                	<input type="text" id=INSTRU_C3N name = "INSTRU_C3N"/>
		                </td>
		                  <td align="right" class="l-table-edit-td" style="width:60px">生产厂家：</td>
		                <td align="left" class="l-table-edit-td" >
		                	<input type="text" id="areaName" name = "areaName"/>
		                </td>
		                <td align="right" class="l-table-edit-td" style="width:60px">供货单位：</td>
		                <td align="left" class="l-table-edit-td" >
		               ...
		               <td align="right" class="l-table-edit-td" style="width:100px">来源类型：</td>
		                <td align="left" class="l-table-edit-td" >
		                	<input type="text" id="areaName" name = "areaName"/>
		                </td>
		               
		               
		                <td align="right" class="l-table-edit-td" style="width:80px">库房：</td>
		                <td align="left" class="l-table-edit-td" >
		                	<input type="text" id="FACTORY_NS" name = "FACTORY_NS"/>
		                </td>
		                
		                <td align="right" class="l-table-edit-td" style="width:120px">批号：</td>
		                <td align="left" class="l-table-edit-td" >
		                	<input type="text" id="INSTRU_C3N" name = "INSTRU_C3N"/>
		                </td>
