        ...
        $(function () {
			...
			$("#oilationname").ligerComboBox({
			 ...
			 $("#areablock").ligerComboBox({
				url:'station_searchAcceptunit.action?orgid=boilerbasicinfo',
				valueField: 'id',
					...
					var operFlag = false;
              	   ...
              	   if(operate == 1){
              	   	   ...
              	   	   jQuery.ajax({
									...
									async : false,
									data: {"grzh":grzh,"grzhName":grzhName,"org_id":org_id,"boilerid":boilerid,"boilername2":boilername2,
									"boilertype2":boilertype2,
									"commissioning_date":commissioning_date,"jrbz":jrbz,"ljjd_s":ljjd_s,
									"status_value":status_value,"yxz2":yxz2,
									"boilercode2":boilercode2,"remark2":remark2},
									success : function(jsondata) { 
              	   ...
              	   //2-修改
              	   		 ...
              	   		 jQuery.ajax({
									...
									url : 'boilerBasicInfo_saveOrUpdate.action',
									async : false,
									data: {"grzh":grzh,"org_id":org_id,"boilerid":boilerid,"commissioning_date":commissioning_date,"jrbz":jrbz,"ljjd_s":ljjd_s,
								"status_value":status_value,"yxz2":yxz2,"grzhName":grzhName,
									"boilername2":boilername2,"boilertype2":boilertype2,"boilercode2":boilercode2,"remark2":remark2},
									success : function(jsondata) { 
									$.ligerDialog.closeWaitting("数据正在保存请稍后。。。");
									if (jsondata != null && typeof(jsondata)!="undefined" && 1 == jsondata){
											onSubmit();
        	...
        	if (rowdata.BLOCKSTATIONNAMEID != null && typeof(rowdata.BLOCKSTATIONNAMEID)!="undefined"){
			...
			if (rowdata.ACCEPT_UNIT!= null && typeof(rowdata.ACCEPT_UNIT)!="undefined"){
			 	accept_unit = rowdata.ACCEPT_UNIT;  //受汽单位ID
			 }else{
			 	accept_unit = "";
			 }
			boilertype = rowdata.BOILER_TYPE; //锅炉类型
			if (rowdata.BOILER_CODE != null && typeof(rowdata.BOILER_CODE)!="undefined"){
				boilercode = rowdata.BOILER_CODE; //锅炉编号
			}else{
				boilercode = "";
			}
			if (rowdata.RATING_CAPACITY != null && typeof(rowdata.RATING_CAPACITY)!="undefined"){
			 	rating_capacity = rowdata.RATING_CAPACITY; //额定水量
			 }else{
			 	rating_capacity = "";
			 }
			 
			 if (rowdata.INJECTION_ALLOCATION_RATE != null && typeof(rowdata.INJECTION_ALLOCATION_RATE)!="undefined"){
			...
			if (rowdata.COMMISSIONING_DATE != null && typeof(rowdata.COMMISSIONING_DATE)!="undefined"){
			 ...
			 if (rowdata.FACTORY_UC != null && typeof(rowdata.FACTORY_UC)!="undefined"){
    ...
    function onSubmit(){
		grid.setOptions({
			parms: [{ name: 'oilationname', value: $("#oilationname").val()},
				...
				{ name: 'boilersName',value: $("#boilersid").val()}]
		});
         	grid.loadData(true);
        }
      function assignM(flg){
			 ...
			 if(flg == 2){
			 		document.getElementById("boilername2").value= boilername;
	              ...
	              $("#sqdw").ligerGetComboBoxManager().selectValue(accept_unit); //受汽单位ID
	        		...
	        		if (boilertype == '湿蒸') {
						...
						$("#boilertype2").ligerGetComboBoxManager().selectValue(boilertype);
					}
              	     		...
              	     		$.ligerDialog.confirm('确定删除吗?', function (yes) {
	              	     		 if(yes){
			                          jQuery.ajax({
											...
											async : false,
											data: {"boilerid":boilerid,"org_id":org_id},
		  ...
		  <div class="navline" style="margin-bottom:4px; margin-top:4px;"></div>
		   ...
		   <div id="edituser" >
		        ...
		        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0">
		            <tr>
		              <td align="left" class="l-table-edit-td" style="width:150px">锅炉名称:</td>
		              
		             	<td align="left" class="l-table-edit-td" style="width:150px">运行组:</td>
		              
		                <td align="left" class="l-table-edit-td" style="width:150px">供热站:</td>
		                 <td align="left" class="l-table-edit-td" style="width:150px">受汽区块:</td>
		                <td align="left" class="l-table-edit-td" style="width:150px">受汽单位:</td>
		                <td align="left" class="l-table-edit-td" style="width:150px">锅炉类型:</td>
		                <td align="left" class="l-table-edit-td" style="width:150px">锅炉编号:</td>
		                 <td align="left" class="l-table-edit-td" style="width:150px">额定水量:</td>
		              
		                 </tr>
		                 <tr>
		                  <td align="left" class="l-table-edit-td" style="">
		                	<input name="boilername2" type="text" id="boilername2"  ltype="text" validate="{required:true,minlength:1,maxlength:20}" />
		              	  </td>
		            	 ...
		            	 <td align="left" class="l-table-edit-td" style="">
		                	<input name="grzh2" type="text" id="grzh2"  ltype="text" validate="{required:true,minlength:1,maxlength:20}" />
		                </td>
		            	 ...
		            	 <td align="left" class="l-table-edit-td" style="">
		                	<input name="boilertype2" type="text" id="boilertype2"  ltype="text" validate="{required:true}" />
		                </td>
		                
		                <td align="left" class="l-table-edit-td" style="">
		                	<input name="boilercode2" type="text" id="boilercode2" ltype="text"  />
		                </td>
		                <td align="left" class="l-table-edit-td" >
		                	<input name="rating_capacity"  id="rating_capacity"  ltype="number" />
		                </td>
		                 </tr>
		                 <tr>
		                ...
		                <td align="left" class="l-table-edit-td" style="width:150px">配注量:</td>
		                 ...
		                 <td align="left" class="l-table-edit-td" style="width:150px">投产日期:</td>
		      			<td align="left" class="l-table-edit-td" style="width:150px">厂家:</td>
		            ...
		            <tr>
		                ...
		                <td align="left" class="l-table-edit-td" >
		                	<input name="injection_allocation_rate"  id="injection_allocation_rate"  ltype="number" />
		                </td>
		                <td align="left" class="l-table-edit-td" >
		                ...
		                <td align="left" class="l-table-edit-td" >
		                 ...
		                 <td align="left" class="l-table-edit-td" >
		                	<input name="factory_nf" type="text" id="factory_nf" ltype="text"  />
		                </td>
