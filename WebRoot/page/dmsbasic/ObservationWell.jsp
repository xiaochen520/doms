	...
	//	var dyear			//设计产能年
        ...
        $(function () {
			...
			$("#oilstationname1").ligerComboBox({
				url:'rulewell_queryOilSationInfo.action?arg=observation',
				valueField: 'id',
			...
			$("#areablock").ligerComboBox({
				url:'rulewell_queryAreablockInfo.action?orgid=observation',
				valueField: 'id',
			...
			$("#blockstationname1").ligerComboBox({
				url:'rulewell_queryStationInfo.action?oilid=observation',
	            valueField: 'id',
			...
			$("#rulewellname1").ligerComboBox({
				url:'obswell_queryWellInfo.action',
				valueField: 'id',
				valueFieldID: 'wellid',
				textField: 'text',
				selectBoxHeight:400,
            ...
            var v = $("form").validate({
                ...
                submitHandler: function ()
                {
              	   	...
              	   	var observation_wellid  = $("#observation_wellid").val();
					...
					var remark  = $("#remark").val();
              	   ...
              	   if(operate == 1){
              	   	   jQuery.ajax({
									type : 'post',
									url : 'obswell_addorUpdateObservation.action',
									async : false,
									data: {"well_name":well_name ,"wellCode":wellCode , "bewell_name":bewell_name ,"wellAreaSelf":wellAreaSelf,
							"commissioning_date":commissioning_date,"jrbz":jrbz,"ljjd_s":ljjd_s,"id":observation_wellid,
										"status_value":status_value,"blockstationname":blockstationname,"remark":remark},
									success : function(jsondata) { 
        	...
        	//用户选择修改数据
        							gh_id = rowdata.GH_ID;
        							observation_wellid = rowdata.OBSERVATION_WELLID;
        ...
        function getWellInitData() {
    		...
    		jQuery.ajax({
    			type : 'post',
    			url : 'obswell_cascadeInit.action',
    			success : function(jsondata) {
		...
		//	$("#oilstationname1").ligerGetComboBoxManager().setText(oilstationname);  
			//$("#areablock1").ligerGetComboBoxManager().setText(areablock);  
		//	$("#blockstationname1").ligerGetComboBoxManager().setText(blockstationname);  
			//$("#wellnum1").ligerGetComboBoxManager().setText(wellnum); 
      ...
      function assignM(flg){
			 ...
			 if(flg == 2){
					$("#blockstationname").ligerGetComboBoxManager().selectValue(gh_id);
			 		document.getElementById("observation_wellid").value = observation_wellid;
	               ...
	               //	document.getElementById("scrapped_date").value= scrapped_date;
			 		...
			 		document.getElementById("observation_wellid").value = "";
              	    		...
              	    		alert('请选择一条你要删除的数据！')
              	     		...
              	     		$.ligerDialog.confirm('确定删除吗?', function (yes) {
	              	     		 if(yes){
			                          jQuery.ajax({
											type : 'post',
											url : 'obswell_removeObsWell.action',
											async : false,
											data: {"observation_wellid":observation_wellid,"org_id":org_id},
	         ...
	         <form name="formsearch" method="post"  id="form1">
	        	<table border="0" cellspacing="1">
					<tr>
		                ...
		                <td align="right" class="l-table-edit-td" style="width:50px">观察井：</td>
		                <td align="left" class="l-table-edit-td" >
		   ...
		   <div id="edituser">
		        ...
		        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0">
		            <tr>
		                ...
		                <td align="left" class="l-table-edit-td" style="width:150px">观察井井号:</td>
		                
		                
		                <td align="left" class="l-table-edit-td" style="width:150px">观察井编码:</td>
		                 <td align="left" class="l-table-edit-td" style="width:150px">所属井区块:</td>
		                ...
		                <td align="left" class="l-table-edit-td" >
		                  ...
		                  <td align="left" class="l-table-edit-td" >
		                	<input name="wellAreaSelf" type="text" id="wellAreaSelf" ltype="text"  />
		                </td>
		            ...
		            <tr>
		                ...
		                <td align="left" class="l-table-edit-td" >
		                	<input name="observation_wellid" type="hidden" id="observation_wellid" />
