    ...
    <script type="text/javascript">
        ...
        { 
        	...
        	$("#gltree").ligerTree(
	            {
	                ...
	                onSelect: function (node){
	                	...
	                	parent.jklbid = node.data.id;
						parent.jklbname = node.data.text;
						parent.jklbtype = node.data.nodetype;
	                }
	            });
          ...
          function initglTree(){
	           	...
	           	jQuery.ajax({
					type : 'post',
					url : 'system_getBLTreeData.action?nowdata='+parseInt(Math.random()*100000),
               ...
               function onBeforeExpandgl(note)
        {
            if (note.data.children && note.data.children.length == 0)
            {
            	...
            	gltreemanager.loadData(note.target,'system_getBLOrgChridData.action?menuid='+gltreeid+'&id='+nowid);
