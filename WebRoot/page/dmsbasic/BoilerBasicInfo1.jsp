        ...
        $(function () {
            ...
            var v = $("form").validate({
                ...
                submitHandler: function ()
                {
					...
					var injection_allocation_rate = $("#injection_allocation_rate").val(); //配注量
					...
					var operFlag = false;
              	   ...
              	   if(operate == 1){
              	   	   ...
              	   	   jQuery.ajax({
									...
									async : false,
									data: {"grzh":grzh,"grzhName":grzhName,"boilername2":boilername2,
											"hidsqqk2id":hidsqqk2id22,"hidsqdw2id":hidsqdw2id2,"boilertype2":boilertype2,
											"boilercode2":boilercode2,"rating_capacity":rating_capacity,"injection_allocation_rate":injection_allocation_rate,
											"status_value":status_value,"jrbz":jrbz,"ljjd_s":ljjd_s,"yxz2":yxz2,
											"commissioning_date":commissioning_date,"factory_nf":factory_nf,
											"remark2":remark2},
