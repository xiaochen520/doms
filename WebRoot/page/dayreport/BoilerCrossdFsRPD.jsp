...
//为公用页面提供接口方法 
	function onJKSubmit(id,name,datatype,basid){ 
           ...
           function onSubmit()
        {
        	...
        	grid.setOptions({
        		parms: [{name: 'areablock',value: areablock},
    					{name: 'blockstationname',value: blockstationname},
    					{name: 'boilersName',value: boilersName},
    					{name: 'acceptunit',value: acceptunit},
		...
		<form id="formsearch" class="l-form">
			<table border="0" cellspacing="1">
				<tr>
					...
					<td style="padding-left: 20px;"><a
						href="javascript:onExport()" class="l-button" style="width:100px">导出报表</a></td>
				</tr>
			</table>
		</form>
	</div>
