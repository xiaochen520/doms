...
<head><title>高干度锅炉日报</title>
   ...
   var oilstationname='';
        $(function () {
			...
			jQuery.ajax({
				type : 'post',
				url : 'ggdglrd_pageInit.action?arg=rb',
	...
	var exportFlag=false;
	 function onExport() {
		     ...
		     //var oilationname1=oilstationname;
			...
			if (exportFlag) {
				...
				boilersName=boilersName;
				acceptunit=acceptunit;
			}
			var totalNum = 0;
			//acceptunit
			var url = 'ggdglrd_searchGGDRD.action?areablock='+encodeURIComponent(areablock)+'&blockstationname='+encodeURIComponent(blockstationname)+'&boilersName='+encodeURIComponent(boilersName)+'&acceptunit='+encodeURIComponent(acceptunit)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum=export'+'&pageCode=rb';
			var urls = 'ggdglrd_searchGGDRD.action?areablock='+encodeURIComponent(areablock)+'&blockstationname='+encodeURIComponent(blockstationname)+'&boilersName='+encodeURIComponent(boilersName)+'&acceptunit='+encodeURIComponent(acceptunit)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum=totalNum'+'&pageCode=rb';
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
...
function DrawEChart() {
	jQuery.ajax({
		type : 'post',
		url : 'ggdglrd_searchAlarmLine1.action',
		data : {
