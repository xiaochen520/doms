...
<head>
	...
	var glmc = parent.glmc;
       ...
       var chinaData =
       [
        { id: 'GAS_INTO_PRESS', text: '站区来气压力',unit:'MPa'},
		 { id: 'GAS1_PRESS', text: '天然气阀前压力',unit:'MPa'},
		 { id: 'FIRE_MEASURE', text: '火量',unit:'%'},
		 { id: 'GAS_FLOW', text: '天然气流量',unit:'m3/h'},
		 { id: 'PUMPIN_PRESS', text: '给水压力',unit:'MPa'},
		 { id: 'PUMPOUT_TEMP', text: '给水温度',unit:'℃'},
		 { id: 'PUMPFC_FREQUENCY', text: '柱塞泵变频频率',unit:'Hz'},
		 { id: 'WATERSUPPLY_FLOW', text: '给水流量',unit:'t/h'},
		 { id: 'STEAMIN_TEMP', text: '蒸汽出口压力',unit:'MPa'},
		 { id: 'STEAMOUT_TEMP', text: '蒸汽出口温度',unit:'℃'},
		 { id: 'STEAM_DRYNESS', text: '蒸汽出口干度',unit:'%'},
		 { id: 'PUMPOUT_PRESS', text: '柱塞泵出口压力',unit:'MPa'},
		 { id: 'CSIN_PRESS', text: '对流段入口压力',unit:'MPa'},
		 { id: 'CSIN_TEMP', text: '对流段入口温度',unit:'℃'},
		 { id: 'CSOUT_PRESS', text: '对流段出口压力',unit:'MPa'},
		 { id: 'CSOUT_TEMP', text: '对流段出口温度',unit:'℃'},
		 { id: 'CONVECTIONR_PRESS_REDUCTION', text: '对流段压降',unit:'MPa'},
		 { id: 'RSIN_PRESS', text: '辐射段入口压力',unit:'MPa'},
		 { id: 'RSIN_TEMP', text: '辐射段入口温度',unit:'℃'},
		 { id: 'RS_PRESS_REDUCTION', text: '辐射段压降',unit:'MPa'},
		 { id: 'RS_TEMP', text: '辐射段出口管温',unit:'℃'},
		 { id: 'GAS2_PRESS', text: '天然气阀后压力',unit:'MPa'},
		 { id: 'GAS3_PRESS', text: '膨胀管压力',unit:'MPa'},
		 { id: 'LUBE_PRESS', text: '润滑油压力',unit:'MPa'},
		 { id: 'LUBE_TEMP', text: '润滑油温度',unit:'℃'},
		 { id: 'FAN_AIR_INTAKE_TEMP', text: '鼓风机进风温度',unit:'℃'},
		 { id: 'BURNER_TEMP', text: '燃烧器喉温',unit:'℃'},
		 { id: 'HEARTH_PRESS', text: '炉膛压力',unit:'Pa'},
		 { id: 'EJECTSMOKE_TEMP', text: '排烟温度',unit:'℃'},
		 { id: 'SYSTEM_VOLTAGE', text: '电网电压',unit:'V'},
		 { id: 'PUMP_MOTOR_CURRENT', text: '柱塞泵电流',unit:'A'},
		 { id: 'PUMP_MOTOR_TEMP', text: '柱塞泵电机温度',unit:'℃'},
		 { id: 'FAN_MOTOR_CURRENT', text: '鼓风机电流',unit:'A'},

		 { id: 'FUEL_GAS_DENSITY', text: '锅炉房可燃气体浓度',unit:'%'},
		 { id: 'H2S_DENSITY', text: '锅炉房H2S气体浓度',unit:'ppm'},
		 { id: 'DAILY_CUMULATIVE_GAS', text: '天然气日累积量',unit:'m3'},
		 { id: 'DAILY_CUMULATIVE_STEAM', text: '注汽日累积量',unit:'t'}
       ];  
        ...
        function onSubmit()
        {
        	if($("#prvar").val() != ''){
                ...
                jQuery.ajax({
					type : 'post',
					url : 'srglrb_getline.action?nowdata='+parseInt(Math.random()*100000),
					async : false,
