...
<head><title>湿蒸汽锅炉日报维护数据</title>
	...
	$(function () {
	    ...
	    function setBoilerData(data,proData) {
			...
			RPD_BOILER_COMMON_ID = rows[0].RPD_BOILER_COMMON_ID;
			...
			// $("#REPORT_DATE").val(rows[0].REPORT_DATE);
				$("#REPORT_DATE").ligerDateEditor({format: "yyyy-MM-dd",labelWidth: 100,labelAlign: 'center',
					cancelable : false,initValue:gd
				});
			 ...
			 $("#MPIN_PRESS").val(rows[0].MPIN_PRESS);
			 ...
			 $("#LUBE_PRESS").val(rows[0].LUBE_PRESS);
           ...
           // var RPD_BOILER_COMMON_ID =$("#RPD_BOILER_COMMON_ID").val();
        	 ...
        	 var STEAM_INJE_UNIT = $("#STEAM_INJE_UNIT").val();
				...
				jQuery.ajax({
					...
					data: {
						"RPD_BOILER_COMMON_ID":RPD_BOILER_COMMON_ID,
						//"BOILERID":BOILERID,
	...
	<form name="form" method="post" id="form">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
			...
			<td align="right" class="l-table-edit-td" style="width:80px">区块：</td>
				...
				<td align="left" class="l-table-edit-td" style="width:80px">
					<input type="text" id="BOILER_NAME" name = "BOILER_NAME" />	
				</td>
				...
				<td align="left" class="l-table-edit-td" style="width:80px">
					<input type="text" id="RUNTIME" name = "RUNTIME" onblur="changValue()" onkeyup="checkData(this)" ltype="text" validate="number:true , max:99.99 " />	
				</td>
				...
				<td align="left" class="l-table-edit-td" style="width:80px">
					<input type="text" id="STEAM_WORK_GROUP" name = "STEAM_WORK_GROUP" />	
				</td>
