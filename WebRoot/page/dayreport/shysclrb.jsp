...
<head>
	...
	var RPD_MOLLIFIER_ID;
        $(function ()
        {
            ...
            jQuery.ajax({
				type : 'post',
				url : 'shysclyxrb_pageInit.action',
         ...
         function onSubmit()
        {
        	//if (onSearchByDate($("#txtDate").val())){
        	 ...
        	 jQuery.ajax({
					type : 'post',
					url : 'shysclyxrb_searchDatas.action?nowdata='+parseInt(Math.random()*100000),
...
"	 <td colspan=22 height=36 class=xl9531547 width=1245 style='height:27.6pt;width:864pt'>风城供汽联合站四合一水处理日报<font class='font531547'><span"+
"	 style='mso-spacerun:yes'>&nbsp;</span></font></td>"+
"	 </tr>"+
"	 <tr>"+
"	  <td colspan=10 class=xl10231547></td>"+
...
"  </td>"+
"	  <td colspan=15 class=xl7931547 width=881 style='border-left:none;width:536pt'>设备关键数据</td>"+
...
"	  <td colspan=6 class=xl9431547 style='border-left:none'>压力</td>"+
...
"	  <td class=xl7931547 width=70 style='border-top:none;border-left:none; width:53pt'>三期增压泵</td>"+
...
"	  <td class=xl7931547 width=70 style='border-top:none;border-left:none;width:53pt'>三期压缩空气</td>"+
"	 </tr>";
	var rowdisabled = "";
	for(var i=0;i<dataArr.length;i++){
		rowdisabled = "";
		 if(dataArr[i].RPD_SHYSCL_T_ID != null && dataArr[i].RPD_SHYSCL_T_ID !="" && typeof(dataArr[i].RPD_SHYSCL_T_ID)!="undefined"){
			 rowdisabled = "";
		 }else{
...
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='RHQZCSL"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:73px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].RHQZCSL+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='CYQZCSL"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:73px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].CYQZCSL+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='ZYBZCSL"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:73px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].ZYBZCSL+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='LT_30101A"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+"  style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].LT_30101A+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='LT_30101B"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].LT_30101B+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='LT_30102A"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+"  style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].LT_30102A+"'/></td>"+
"	  <td class=xl8031547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='LT_30102B"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].LT_30102B+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='LT_30301"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].LT_30301+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='LT_30302"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].LT_30302+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='ZYBYL1"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+"  style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].ZYBYL1+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='ZYBYL2"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].ZYBYL2+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='ZYBYL3"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+"  style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].ZYBYL3+"'/></td>"+
"	  <td class=xl8931547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='YSKQYL1"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].YSKQYL1+"'/></td>"+
"	  <td class=xl8831547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='YSKQYL2"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].YSKQYL2+"'/></td>"+
"	  <td class=xl8831547 width:66 style='border-top:none;border-left:none;width:66pt'><input id='YSKQYL3"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].YSKQYL3+"'/></td>"+
"	  <td class=xl11131547  width=66 style='border-left:none;width:66pt;background:transparent'><input id='HARDNESS"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+"  style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].HARDNESS+"'/></td>"+
"	  <td class=xl11131547  width=66 style='border-left:none;width:66pt;background:transparent'><input id='OXYGEN_BEARING"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].OXYGEN_BEARING+"'/></td>"+
"	  <td class=xl11131547  width=66 style='border-left:none;width:66pt;background:transparent'><input id='CHLORIDE"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].CHLORIDE+"'/></td>"+
"	  <td class=xl11131547  width=66 style='border-left:none;width:66pt;background:transparent'><input id='BASICITY"+i+"' onkeyup='checkData(this)' type='text' "+rowdisabled+" style='background:transparent;border:0px solid;width:45px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+dataArr[i].BASICITY+"'/></td>"+
"  <td style='display: none'><input id='RPD_SHYSCL_T_ID"+i+"' type='hidden' value='"+dataArr[i].RPD_SHYSCL_T_ID+"'></td>";
...
"	  <td colspan=9 height=30 class=xl10731547 width=496 style='height:22.5pt;width:374pt;background:transparent'>记事：白班<br><br></td>"+
"	  <td colspan=13 class=xl10731547 width=649 style='border-left:none;width:490pt;background:transparent'>记事：夜班<br><br></td>"+
"	 </tr>"+
"	 <tr class=xl7731547 height=126 style='mso-height-source:userset;height:94.5pt'>"+
"	  <td colspan=9 height=126 class=xl10931547 width=496 style='height:94.5pt;width:374pt;background:transparent'><input id='BZ1' type='text' style='background:transparent;border:0px solid;width:400px;line-height:30px;height:30px;font-size: 12pt;text-align:left;' value='"+WATERMESSAGE.BZ1+"'/></td>"+

"	  <td colspan=13 class=xl10931547 width=649 style='border-left:none;width:490pt;background:transparent'><input id='BZ2' type='text' style='background:transparent;border:0px solid;width:400px;line-height:30px;height:30px;font-size: 12pt;text-align:left;' value='"+WATERMESSAGE.BZ2+"'/></td>"+
"	 </tr>"+
"	 <tr class=xl7731547 height=60 style='mso-height-source:userset;height:45.0pt'>"+
"	  <td colspan=9 height=60 class=xl11431547 width=496 style='border-right:.5pt solid black;background:transparent; height:45.0pt;width:374pt'><span style='mso-spacerun:yes'>&nbsp;</span>填表人：<input id='TBR1' type='text' style='background:transparent;border:0px solid;width:83px;line-height:30px;height:30px;font-size: 12pt;text-align:center;' value='"+WATERMESSAGE.TBR1+"'/></td>"+
"	  <td colspan=13 class=xl11431547  width=649 style='border-right:.5pt solid black;background:transparent; border-left:none;width:490pt'><span style='mso-spacerun:yes'>&nbsp;</span>填表人：<input id='TBR2' type='text' style='background:transparent;border:0px solid;width:123px;line-height:120px;height:80px;font-size: 12pt;text-align:center;' value='"+WATERMESSAGE.TBR2+"'/></td>"+
"	 </tr>"+
"	</table>";
         ...
         */
			...
			//加药重量1
			 ...
			 //白班 夜班记事
          	...
          	if (SHR != null && typeof(SHR)!="undefined" && SHR != ""){
              	...
              	var firstStr = "";
             	for(var i=0;i<13;i++){
             		firstArr.push($("#RPD_SHYSCL_T_ID"+i).val());
             	...
             	if (modifyDataFlag($("#txtDate").val())) {
          		 jQuery.ajax({
  					type : 'post',
  					url : 'shysclyxrb_updateDatas.action?nowdata='+parseInt(Math.random()*100000),
         ...
         function onAudit()
         {
         	if (SHR != null && typeof(SHR)!="undefined" && SHR != ""){
         		...
         		if (chekAduitByDate($("#txtDate").val())) {
         		 jQuery.ajax({
 					type : 'post',
 					url : 'shysclyxrb_onAudit.action?nowdata='+parseInt(Math.random()*100000),
         ...
         function onExport() {
     		...
     		var url = "shysclyxrb_exportExcel.action?txtDate="+encodeURIComponent(txtDate)+"&WATERMESSAGEID="+encodeURIComponent(WATERMESSAGEID);
