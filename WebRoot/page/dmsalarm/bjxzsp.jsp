	    ...
	    <div class="navline" style="margin-bottom:4px; margin-top:4px;"></div>
	         ...
	         <form name="formsearch" method="post"  id="form1">
	        	<table border="0" cellspacing="1">
					<tr>
						 <td align="right" class="l-table-edit-td" style="width:60px">申请人员：</td>
		                <td align="left" class="l-table-edit-td" style="width:80px">
		                	<input type="text" id="sqname" name = "sqname"/>
		                </td>
		                <td align="left">
		                </td>
		               <td align="right" class="l-table-edit-td" style="width:100px">执行状态：</td>
		                <td align="left" class="l-table-edit-td" style="width:80px">
		                	<input type="text" id="zxzt" name = "zxzt" />
		                </td>
		                <td align="left">
		                </td>
		                <td align="right" class="l-table-edit-td" style="width:100px">申请日期：</td>
		                <td align="left" class="l-table-edit-td" style="width:80px">
