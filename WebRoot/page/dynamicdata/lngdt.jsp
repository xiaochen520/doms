    ...
    <script type="text/javascript">
        ...
        $(function () {
        	 ...
        	 //获取报表及功能按钮ｊｓ
                jQuery.ajax({
					type : 'post',
					url : 'sagdhrdt_pageInit.action?arg=lng',
					async : false,
		...
		var totalNum = 0;
			...
			var url = 'sagdhrdt_searchDataslng.action?startDate='+encodeURIComponent(txtDate)+'&endDate='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('export');
		   var urls = 'sagdhrdt_searchDataslng.action?startDate='+encodeURIComponent(txtDate)+'&endDate='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('totalNum');
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
