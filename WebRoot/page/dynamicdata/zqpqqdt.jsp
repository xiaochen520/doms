...
<head><title>蒸汽配汽撬动态数据</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
			...
			var Data = [{ id: 1, text: '重18SAGD-3#配汽撬' }, 
           				{ id: 2, text: '50#配汽撬'},
            			{ id: 3, text: '51#配汽撬'},
            			{ id: 4, text: '52#配汽撬'}
           				 ];
		...
		var totalNum = 0;
			var url = 'zqpqq_searchZqpqqdt.action?zqpqq='+encodeURIComponent(zqpqq)+'&startDate='+encodeURIComponent(txtDate)+'&endDate='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('export');
		   var urls = 'zqpqq_searchZqpqqdt.action?zqpqq='+encodeURIComponent(zqpqq)+'&startDate='+encodeURIComponent(txtDate)+'&endDate='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('totalNum');
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
    ...
    <div class="searchbox">
        <form id="formsearch" class="l-form"> 
        	<table border="0" cellspacing="1">
				<tr>
					<td align="right" class="l-table-edit-td" style="width:100px">配汽撬名称：</td>
	                <td align="left" class="l-table-edit-td" style="width:120px">
	                	<input type="text" id="zqpqq" name="zqpqq"/>
	                </td>
