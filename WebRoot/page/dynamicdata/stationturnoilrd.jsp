...
<head><title>注转站信息管理</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
        	 ...
        	 //获取报表及功能按钮ｊｓ
                jQuery.ajax({
					type : 'post',
					url : 'stationrd_pageZYInit.action',
	...
	if(new Date(start.replace(/\-/g, "\/")) > new Date(end.replace(/\-/g, "\/"))) {
	 ...
	 function onExport() {
			...
			var url = 'stationrd_searchBlockstationData.action?oilstationname='+encodeURIComponent(oilstationname)+'&areablock='+encodeURIComponent(areablock)+'&blockstationname='+encodeURIComponent(blockstationname)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum=export';
			var urls = 'stationrd_searchBlockstationData.action?oilstationname='+encodeURIComponent(oilstationname)+'&areablock='+encodeURIComponent(areablock)+'&blockstationname='+encodeURIComponent(blockstationname)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum=totalNum';
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
