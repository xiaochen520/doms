...
<head><title>宇澄汽线温压动态数据</title>
    ...
    <script type="text/javascript">
		...
		var totalNum = 0;
			var url = 'ycgx_searchYcgxdt.action?ycgx='+encodeURIComponent(ycgx)+'&startDate='+encodeURIComponent(txtDate)+'&endDate='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('export');
		   var urls = 'ycgx_searchYcgxdt.action?ycgx='+encodeURIComponent(ycgx)+'&startDate='+encodeURIComponent(txtDate)+'&endDate='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('totalNum');
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
    ...
    <div class="searchbox">
        <form id="formsearch" class="l-form"> 
        	<table border="0" cellspacing="1">
				<tr>
					<td align="right" class="l-table-edit-td" style="width:100px">管线站号：</td>
	                <td align="left" class="l-table-edit-td" style="width:120px">
	                	<input type="text" id="ycgx" name="ycgx"/>
	                </td>
