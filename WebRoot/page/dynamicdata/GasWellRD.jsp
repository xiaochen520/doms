           ...
           function onSubmit()
        {
           ...
           function onExport() {
			...
			var wellnum=$("#rulewellname1").val();
   			...
   			var totalNum = 0;
   			var url = 'gasrd_searchInstru.action?oilstationname1='+encodeURIComponent(oilstationname)+'&areablock1='+encodeURIComponent(areablock)+'&blockstationname1='+encodeURIComponent(blockstationname)+'&rulewellname1='+encodeURIComponent(wellnum)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('export')+'&ghname='+encodeURIComponent(gh);
   			var urls = 'gasrd_searchInstru.action?oilstationname1='+encodeURIComponent(oilstationname)+'&areablock1='+encodeURIComponent(areablock)+'&blockstationname1='+encodeURIComponent(blockstationname)+'&rulewellname1='+encodeURIComponent(wellnum)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('totalNum')+'&ghname='+encodeURIComponent(gh);
   			$.ajax({
   				type : 'post',
   				url : urls,
   				async : false,
