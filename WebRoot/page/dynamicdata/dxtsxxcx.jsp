   ...
   <script src="../../lib/json2.js" type="text/javascript"></script> 
    ...
    <script type="text/javascript">
       ...
       function onSubmit()
		...
		var totalNum = 0;
			var url = 'bjxzzxcx_searchBjcx.action?startDate='+encodeURIComponent(txtDate)+'&endDate='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('export');
		   var urls = 'bjxzzxcx_searchBjcx.action?startDate='+encodeURIComponent(txtDate)+'&endDate='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('totalNum');
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
        ...
        <form id="formsearch" class="l-form"> 
        	<table border="0" cellspacing="1">
				<tr>
	                ...
	                <td align="right" class="l-table-edit-td" style="width:40px">推送时间段：</td>
					<td><input type="text" id="txtDate" ltype="date"/></td>
					<td valign="middle">--</td>
					<td><input type="text" id="txtDate1" ltype="date"/></td>

					<td align="right" class="l-table-edit-td" style="width:80px">接受部门：</td>
					<td align="left" class="l-table-edit-td" style="width:80px"><input
						type="text" id="jsbm" name="jsbm" /></td>

					<td align="right" class="l-table-edit-td" style="width:80px">接收人：</td>
					<td align="left" class="l-table-edit-td" style="width:80px"><input
						type="text" id="jsr" name="jsr" /></td>
						
						
<!-- 					<td align="right" class="l-table-edit-td" style="width:80px">手自动推送：</td>
					<td align="left" class="l-table-edit-td" style="width:30px"><input
						type="text" id="zsd" name="szd" /></td> -->
						
					<td align="right" class="l-table-edit-td" style="width:80px">推送部门：</td>
					<td align="left" class="l-table-edit-td" style="width:80px"><input
						type="text" id="tsbm" name="tsbm" /></td>
						
					<td align="right" class="l-table-edit-td" style="width:40px">推送人：</td>
					<td align="left" class="l-table-edit-td" style="width:80px"><input
						type="text" id="tsr" name="tsr" /></td>
