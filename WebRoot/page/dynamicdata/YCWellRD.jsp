...
<head><title>异常井动态数据</title>
   ...
   var eee;
             ...
             $("#txtDate").ligerDateEditor(
                {
                  ...
                  //  label: '格式化日期',
                    labelWidth: 100,
                    labelAlign: 'center',showTime: true,
                    cancelable : false
            });
        ...
        function onJKSubmit(id,name,datatype,basid){ 
			...
			grid.setOptions({
				parms: [{ name: 'oilationname', value: oilstationname},
					...
					{ name: 'blockstationname1',value: blockstationname},
					{ name: 'rulewellname1',value:well}]
			});
			grid.loadData(true);
		}
           function onSubmit()
		...
		function onExport() {
			...
			var totalNum = 0;
			var url = 'ycwellRD_searchYCWell.action?oilstationname1='+encodeURIComponent(oilstationname1)+'&areablock1='+encodeURIComponent(areablock1)+'&blockstationname1='+encodeURIComponent(blockstationname1)+'&rulewellname1='+encodeURIComponent(rulewellname1)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+'export';
			var urls = 'ycwellRD_searchYCWell.action?oilstationname1='+encodeURIComponent(oilstationname1)+'&areablock1='+encodeURIComponent(areablock1)+'&blockstationname1='+encodeURIComponent(blockstationname1)+'&rulewellname1='+encodeURIComponent(rulewellname1)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+'totalNum';
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
