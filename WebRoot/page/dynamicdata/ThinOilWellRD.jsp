   ...
   <link href="../../lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
	...
	var grid;
        ...
        lang: {
            ...
            $("#pageloading").hide();
			$("#txtDate").ligerDateEditor({ showTime: true, labelWidth: 160, labelAlign: 'left' ,showTime: true,format :"yyyy-MM-dd hh:mm"}).setValue(myDate().Format("yyyy-MM-dd hh:mm"));
			$("#txtDate1").ligerDateEditor({ showTime: true, labelWidth: 160, labelAlign: 'left' ,format :"yyyy-MM-dd hh:mm"}).setValue(secondDate().Format("yyyy-MM-dd hh:mm"));
		...
		function onJKSubmit(id,name,datatype,basid){ 
			...
			grid.setOptions({
				parms: [{ name: 'oilstationname1', value: oilstation },
	...
	function onExport() {
		...
		var totalNum = 0;
		var url = 'thinoilrd_searchInstru.action?oilstationname1='+encodeURIComponent(oilstationname1)+'&areablock1='+encodeURIComponent(areablock1)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('export')+'&blockstationname1='+encodeURIComponent(blockstationname1)+'&rulewellname1='+encodeURIComponent(rulewellname1)+'&ghname='+encodeURIComponent(gh);
		var urls = 'thinoilrd_searchInstru.action?oilstationname1='+encodeURIComponent(oilstationname1)+'&areablock1='+encodeURIComponent(areablock1)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('totalNum')+'&blockstationname1='+encodeURIComponent(blockstationname1)+'&rulewellname1='+encodeURIComponent(rulewellname1)+'&ghname='+encodeURIComponent(gh);
		$.ajax({
			type : 'post',
			url : urls,
			async : false,
