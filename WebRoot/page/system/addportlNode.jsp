...
<head><title>添加PORTAL菜单节点</title>
    ...
    <script type="text/javascript">
        ...
        var SIGNData = { Rows: [{ "PARAMID": null, "PORTALMENUID": null, "PARAMNAME": "user", "PARAMVALUE":null },{ "PARAMID": null, "PORTALMENUID": null, "PARAMNAME": "password", "PARAMVALUE":null }], Total: 2 };
        $(function () {
         ...
         function onSubmit()
        {
        	...
        	if($("#menuname").val() == ""){
        		...
        		jQuery.ajax({
						type : 'post',
						url : 'portal_addPortalNode.action',
						async : false,
						data: {"pid":pid,
								"nodetype":nodetype,
								"menuname":$("#menuname").val(),
								"menuaddr":$("#menuaddr").val(),
