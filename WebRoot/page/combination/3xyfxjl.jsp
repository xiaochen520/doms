       ...
       function onSubmit()
        {
        	 ...
        	 jQuery.ajax({
					type : 'post',
					url : 'xyfx3_searchFxjl3.action?SYear='+encodeURIComponent(SYear)+'&SMonth='+encodeURIComponent(SMonth),
					success : function(data) { 
					if (data != null && typeof(data)!="undefined"&& data!=""){
							var outData = eval('(' + data + ')');
							//alert(data)
...
//									    var U1S1SS = outData.JSONDATA.U1S1SS;									    
						    	...
						    	$("#tableHtml").html('');
					     		 ...
					     		 " <td colspan=17 height=28 class=xl71 style='height:21.0pt'"+
					     		  ">稀油注输联合处理站分线计量日报表</td>"+
					     		" </tr>"+	
							     		"<tr height=24 style='mso-height-source:userset;height:18.0pt'>"+
 										" <td colspan=2 class=xl65>值班人：</td>"+
											"<td colspan=4 class=xl65><input id='ZBR' type='text' style='background:transparent;border:0px solid;font-size: 12pt;text-align:center' disabled='disabled'/></td> "+							     		
							     		" <td colspan=2 class=xl65>审核：</td>"+
											"<td colspan=4 class=xl65><input id='SHR' type='text' style='background:transparent;border:0px solid;font-size: 12pt;text-align:center' disabled='disabled' value='"+SHR+"'/></td> "+							     		
							     		" <td colspan=2 class=xl65>日期：</td>"+
										" <td colspan=3 class=xl65><input id='RQ' type='text'  style='background:transparent;border:0px solid;font-size: 12pt;text-align:center' disabled='disabled' value='"+RQ+"'/></td> "+							     		
							     		 "</tr>"+							     		 
							     		"<tr height=24 style='mso-height-source:userset;height:18.0pt'>"+
							     		 " <td bgColor=#CCCCFF  height=58 class=xl69 style='border-bottom:.5pt solid black;"+
					     		 		"height:18.0pt;border-top:none'>单位</td>"+	
					     		 		" <td bgColor=#CCCCFF colspan=3 class=xl65 style='border-left:none'>夏子街</td>"+						     		
										" <td bgColor=#CCCCFF colspan=3 class=xl65 style='border-left:none'>乌尔禾</td>"+	
										" <td bgColor=#CCCCFF colspan=2 class=xl65 style='border-left:none'>分线计量</td>"+
										" <td bgColor=#CCCCFF colspan=2 class=xl65 style='border-left:none'>净化罐</td>"+	
										" <td bgColor=#CCCCFF rowspan=3 class=xl65 style='border-left:none'>盘库</td>"+	
							     		" <td bgColor=#CCCCFF rowspan=2 colspan=2 class=xl65 style='border-left:none'>输差</td>"+
							     		" <td bgColor=#CCCCFF rowspan=2 colspan=3 class=xl65 style='border-left:none'>备注</td>"+
							     		"</tr>"+							     		
							     		"<tr height=24 style='mso-height-source:userset;height:18.0pt'>"+
							     		"<td bgColor=#CCCCFF rowspan=2 class=xl65 style='border-bottom:.5pt solid black;"+
					     		 		"height:18.0pt;border-top:none'> 日期</td>"+
							     		 " <td bgColor=#CCCCFF colspan=3 class=xl65 style='border-left:none'>夏子街来液</td>"+
							     		 " <td bgColor=#CCCCFF colspan=3 class=xl65 style='border-left:none'>乌尔禾来液</td>"+
							     		 " <td bgColor=#CCCCFF rowspan=2 class=xl65 style='border-left:none'>总液量（m3）</td>"+
							     		 " <td bgColor=#CCCCFF rowspan=2 class=xl65 style='border-left:none'>总油量（t）</td>"+ 
							     		  " <td bgColor=#CCCCFF rowspan=2 class=xl65 style='border-left:none'>液量</td>"+
							     		 " <td bgColor=#CCCCFF rowspan=2 class=xl65 style='border-left:none'>油量</td>"+ 
							     		
							     		"</tr>"+					     		 							     		
							     		"<tr height=24 style='mso-height-source:userset;height:18.0pt'>"+							     		
							     		"<td bgColor=#CCCCFF class=xl65 style='border-left:none'>累计流量（m³）</td>"+
							     		"<td bgColor=#CCCCFF class=xl65 style='border-left:none'>油量（t）</td>"+
							     		"<td bgColor=#CCCCFF class=xl65 style='border-left:none'>含水（%）</td>"+
							     		"<td bgColor=#CCCCFF class=xl65 style='border-left:none'>累计流量（m³）</td>"+
							     		"<td bgColor=#CCCCFF class=xl65 style='border-left:none'>油量（t）</td>"+
							     		"<td bgColor=#CCCCFF class=xl65 style='border-left:none'>含水（%）</td>"+
							     		"<td bgColor=#CCCCFF class=xl65 style='border-left:none'>液量</td>"+
							     		"<td bgColor=#CCCCFF  class=xl65 style='border-left:none'>油量</td>"+ 
							     		 " <td bgColor=#CCCCFF colspan=3 class=xl65 style='border-left:none'>说明仪表及自动化情况</td>"+ 
							     		"</tr>";							     								     		
							     		var disStr="";
							     		if(mod==1){
					     	 	 ...
					     	 	 for(var i=0; i<U2OILS.length; i++) {
						     	 	 if(U2OILS[i].report_date == '旬合计'){						     	 		 							     	 		 	
										...
										"<td  height=24 class=xl65111  type='hidden' style='display: none'>"+U2OILS[i].rpd_xyl_line_messure_id+"</td>"+									     		
							    			  "<td  height=24 class=xl65111 style='height:18.0pt;border-top:none'>"+U2OILS[i].report_date+"</td>"+
								     		  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].xzjll+"</td>"+
								     		  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].xzjyl+"</td>"+
								     		  "<td class=xl65111  style='border-top:none;border-left:none'>"+U2OILS[i].xzjhs+"</td>"+
								     		  "<td class=xl65111  style='border-top:none;border-left:none'>"+U2OILS[i].wehll+"</td>"+
								     		  "<td class=xl65111  style='border-top:none;border-left:none'>"+U2OILS[i].wehyl+"</td>"+
								     		  "<td class=xl65111  style='border-top:none;border-left:none'>"+U2OILS[i].wehhs+"</td>"+
								     		 ...
								     		 "<td class=xl65111  style='border-top:none;border-left:none'>"+U2OILS[i].pk+"</td>"+
						     	 	 ...
						     	 	 tableval += "<tr height=24 style='mso-height-source:userset;height:18.0pt'>"+
						     	 	 	...
						     	 	 	tableval += "<tr height=24  style='mso-height-source:userset;height:18.0pt'>"+
						     	 	 	  "<td  height=24 class=xl65111  type='hidden' style='display: none'>"+U2OILS[i].rpd_xyl_line_messure_id+"</td>"+
							    			"<td  height=24 class=xl65111 style='height:18.0pt;border-top:none'>"+U2OILS[i].report_date+"</td>"+
								     		 "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].xzjll+
								     		  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].xzjyl+
								     		  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].xzjhs+
								     		  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].wehll+
								     		  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].wehyl+
								     		  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].wehhs+							     		  								     		
								     		  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].zyel+								     		 								     		 
								     		  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].zyoul+
								     		 "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].jhgye+
								     		 "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].jhgyou+								     		
								     		 "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].pk+
								     		 "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].scyel+
								     		 "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].scyoul+
								     		 "<td class=xl65 colspan=3 style='border-top:none;border-left:none;text-align:left'>"+U2OILS[i].remark+ 
											"</tr>";
						     	 	 }	
					     	 	 } 
					     		"</table>";					     								     	
          ...
          function onExport() {
     		var SYear = $("#SYear").val();
			var SMonth = $("#SMonth").val();
     		var url = "xyfx3_exportxyfx3.action?SYear="+encodeURIComponent(SYear)+'&SMonth='+encodeURIComponent(SMonth);
