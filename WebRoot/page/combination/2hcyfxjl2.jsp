       ...
       function onSubmit()
        {
        	 jQuery.ajax({
					type : 'post',
					url : 'cyfxsc2_searchFxjl2.action?txtDate='+$("#txtDate").val(),
					success : function(data) { 
					if (data != null && typeof(data)!="undefined"&& data!=""){
							var outData = eval('(' + data + ')');
							//alert(data)
						    	...
						    	$("#tableHtml").html('');
					     		...
					     		" </tr>"+	
										...
										" <td colspan=6 class=xl65><input id='RQ' type='text'  style='background:transparent;border:0px solid;font-size: 12pt;text-align:center' disabled='disabled' value='"+RQ+"'/></td> "+							     		
							     		...
							     		" <td bgColor=#CCCCFF class=xl65 style='border-left:none'>净化罐</td>"+
							     		" <td bgColor=#CCCCFF rowspan=2 class=xl65 style='border-left:none'>抽底水罐号</td>"+
							     		 " <td bgColor=#CCCCFF  class=xl65 style='border-left:none'>抽底水液位</td>"+
							     		 " <td bgColor=#CCCCFF  class=xl65 style='border-left:none'>底水</td>"+
							     		" <td bgColor=#CCCCFF  class=xl65 style='border-left:none'>污油</td>"+
							     		
							     		" <td bgColor=#CCCCFF   class=xl65 style='border-left:none'>盘库数据</td>"+
							     		 " <td bgColor=#CCCCFF colspan=12 colspan=8 class=xl65 style='border-left:none'>备注</td>"+
							     		"</tr>"+							     		
							     				"<tr height=24 style='mso-height-source:userset;height:18.0pt'>"+
							     		 " <td bgColor=#CCCCFF class=xl65 style='border-bottom:.5pt solid black;border-top:none'>液量（m3）</td>"+	
							     		 " <td bgColor=#CCCCFF  class=xl65 style='border-left:none'>油量（t）</td>"+
							     		 " <td bgColor=#CCCCFF  class=xl65 style='border-left:none'>油量（t）</td>"+
							     		 " <td bgColor=#CCCCFF  class=xl65 style='border-left:none'>（m）</td>"+							     		  
							     		  " <td bgColor=#CCCCFF   class=xl65 style='border-left:none'>（t）</td>"+							     		  
							     		   " <td bgColor=#CCCCFF class=xl65 style='border-left:none'>（t）</td>"+
							     		
							     		 " <td bgColor=#CCCCFF  class=xl65 style='border-left:none'>盘库油量（t）</td>"+
							     	...
							     	for ( var i = 0; i < U2OILS.length; i++) {
							     		...
							     		tableval += "<tr height=24 style='mso-height-source:userset;height:18.0pt'>"+
								     		   "<td style='display: none'><input id='rpd_cy2_sc_messure_id' type='hidden' value='"+U2OILS[i].rpd_cy2_sc_messure_id+"'></td>"+							
								     		 "<td id='report_date' height=24 class=xl65  style='height:18.0pt;border-top:none'>"+U2OILS[i].report_date+"</td>"+	
								     		  "<td class=xl65  style='border-bottom:.5pt solid black;border-top:none'><input id='sagd6000ye'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:70px;line-height:25px;height:18.0px;font-size: 10pt;text-align:center;' value="+U2OILS[i].sagd6000ye+"></td>"+
								     		  "<td class=xl65  style='border-top:none;border-left:none'><input id='sagd6000you'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:70px;line-height:25px;height:18.0px;font-size: 10pt;text-align:center;' value="+U2OILS[i].sagd6000you+"></td>"+
								     		  "<td class=xl65  style='border-top:none;border-left:none'><input id='jhgyou'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:70px;line-height:25px;height:18.0px;font-size: 10pt;text-align:center;' value="+U2OILS[i].jhgyou+"></td>"+
								     		  "<td class=xl65  style='border-top:none;border-left:none'><input id='cdsgh'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:70px;line-height:25px;height:18.0px;font-size: 10pt;text-align:center;' value="+U2OILS[i].cdsgh+"></td>"+
								     		  "<td class=xl65  style='border-top:none;border-left:none'><input id='chdyw'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:70px;line-height:25px;height:18.0px;font-size: 10pt;text-align:center;' value="+U2OILS[i].chdyw+"></td>"+
								     		  "<td class=xl65  style='border-top:none;border-left:none'><input id='ds'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:70px;line-height:25px;height:18.0px;font-size: 10pt;text-align:center;' value="+U2OILS[i].ds+"></td>"+
								     		  "<td class=xl65  style='border-top:none;border-left:none'><input id='wy'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:70px;line-height:25px;height:18.0px;font-size: 10pt;text-align:center;' value="+U2OILS[i].wy+"></td>"+							     	
								     		  "<td class=xl65  style='border-top:none;border-left:none'><input id='pkyl'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:70px;line-height:25px;height:18.0px;font-size: 10pt;text-align:center;' value="+U2OILS[i].pkyl+"></td>"+
								     		  "<td class=xl65 colspan=12 style='border-top:none;border-left:none'><input id='remark'  type='text'  "+disStr+"    onkeyup='checkData(this)' style='background:transparent;border:0px solid;width:1150px;line-height:25px;height:18.0px;font-size: 10pt;text-align:left;' value="+U2OILS[i].remark+"></td>"+
											"</tr>";
						     	 	 }	
					     	 	 } 
          ...
          function onSave()
        	...
        	var	RQ = $("#RQ").val();    		
          	if (SHR != null && typeof(SHR)!="undefined" && SHR != ""){
          		...
          		var firstArr = [];
              	var firstStr = "";																												
             		firstArr.push($("#rpd_cy2_sc_messure_id").val());
             		firstArr.push($("#report_date").val());
             		firstArr.push($("#sagd6000ye").val());
             		firstArr.push($("#sagd6000you").val());
             		firstArr.push($("#jhgyou").val());
             		firstArr.push($("#cdsgh").val());
             		firstArr.push($("#chdyw").val());
             		firstArr.push($("#ds").val());
             		firstArr.push($("#wy").val());
             		firstArr.push($("#pkyl").val());
                ...
                var myday = new Date().Format("yyyy-MM-dd");
             	if (modifyDataFlag(myday)) {
          		 jQuery.ajax({
  					type : 'post',
  					url : 'cyfxsc2_update.action?nowdata='+parseInt(Math.random()*100000),
...
//         		if (chekAduitByDate($("#txtDate").val())) {
         		 jQuery.ajax({
 					type : 'post',
 					url : 'cyfxsc2_onAudit.action?nowdata='+parseInt(Math.random()*100000),
