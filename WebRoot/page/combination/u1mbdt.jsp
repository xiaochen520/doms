    ...
    <script type="text/javascript">
   	...
   	var grid;
		...
		var totalNum = 0;
			...
			var url = 'u1mbdt_searchDatas.action?date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('export');
		   var urls = 'u1mbdt_searchDatas.action?date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('totalNum');
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
