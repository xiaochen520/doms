	...
	var  RPDREPORTMESSAGEID ="";
         ...
         function onSubmit()
        {
        	//if (onSearchByDate($("#txtDate").val())){
        	 jQuery.ajax({
					type : 'post',
					url : 'linemxy_searchLineMeasu.action?txtDate='+$("#txtDate").val(),
					success : function(data) { 
						if (data != null && typeof(data)!="undefined"&& data!=""){
							var outData = eval('(' + data + ')');
							//alert(data)
							if(outData.ERRMSG != null && typeof(outData.ERRMSG)!="undefined"){
								...
								$.ligerDialog.error(outerror(outData.ERRCODE));
						     	...
						     	tableval ="<table border=0 cellpadding=0 cellspacing=0 style='border-collapse:"+
					     		 ...
					     		 " <td colspan=9 height=28 class=xl71 style='height:21.0pt'"+
					     		  ">稀油注输联合处理站 分线计量 日报表</td>"+
					     		" </tr>"+
					     		 ...
					     		 " <td bgColor=#CCCCFF colspan=4 class=xl65 style='border-left:none'>夏子街来液</td>"+
					     		 " <td bgColor=#CCCCFF colspan=4 class=xl65 style='border-left:none'>乌尔禾来液</td>"+
					     		 ...
					     		 "</tr>";
					     	 	 for(var i=0; i<U2OILS.length; i++) {
						     	 	 if(U2OILS[i].REPORT_TIME == '班累积'){
											  ...
											  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].FT_AVE2+"</td>"+
											  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].FT_HH_102+"</td>"+
											  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].AT_AVE2+"</td>"+
											  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].oil+"</td>"+
											  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].FT_AVE1+"</td>"+
											  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].FT_HH_101+"</td>"+
											  "<td class=xl65111 style='border-top:none;border-left:none'>"+U2OILS[i].AT_AVE1+"</td>"+
								     		...
								     		" </tr>";
											  ...
											  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].FT_AVE2+"</td>"+
											  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].FT_HH_102+"</td>"+
											  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].AT_AVE2+"</td>"+
											  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].oil+"</td>"+
											  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].FT_AVE1+"</td>"+
											  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].FT_HH_101+"</td>"+
											  "<td class=xl65 style='border-top:none;border-left:none'>"+U2OILS[i].AT_AVE1+"</td>"+
         ...
         function onSave()
        {
         ...
         function onExport() {
     		...
     		var url = "linemxy_exportLineMeasure.action?txtDate="+encodeURIComponent(txtDate) + '&reportName='+encodeURIComponent('分线计量日报表');
