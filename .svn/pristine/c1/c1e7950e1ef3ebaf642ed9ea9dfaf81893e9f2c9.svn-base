    ...
    <script type="text/javascript">
        ...
        $(function () {
			...
			$("#well_station").ligerComboBox({
			 ...
			 $("#HOT_WASH_TYPE").ligerComboBox({
					url:'rxqlwh_searchHOT_WASH_TYPE.action',
					valueField: 'id',
					valueFieldID: 'hotType',
					textField: 'text',
					selectBoxHeight:200,
					selectBoxWidth:100,
					hideOnLoseFocus:true,
             ...
             $.metadata.setType("attr", "validate");
                ...
                submitHandler: function ()
                {
					...
					var stim_code  = $("#stim_code").val();
					var PARAFFIN_MELT_TEMP  = $("#PARAFFIN_MELT_TEMP").val();
					var PARAFFIN_MELT_VOL  = $("#PARAFFIN_MELT_VOL").val();
					var HOT_WASH_TYPE  = $("#hotType").val();
					var REMARK  = $("#REMARK").val();
              	   ...
              	   if(operate == 1){
              	   	   ...
              	   	   jQuery.ajax({
									type : 'post',
									url : 'rxqlwh_addorUpdateDatas.action',
									async : false,
									data: {"well_name":well_name ,
											"event_date":event_date,
											"stim_code":stim_code ,
											"HOT_WASH_TYPE":HOT_WASH_TYPE,
											"PARAFFIN_MELT_TEMP":PARAFFIN_MELT_TEMP,
											"PARAFFIN_MELT_VOL":PARAFFIN_MELT_VOL,
											"REMARK":REMARK},
              	   ...
              	   //2-修改
              	   		 ...
              	   		 jQuery.ajax({
									...
									data: {"well_name":well_name ,
											...
											"PARAFFIN_MELT_TEMP":PARAFFIN_MELT_TEMP,
											"PARAFFIN_MELT_VOL":PARAFFIN_MELT_VOL,
											"REMARK":REMARK,"HOTWASH_PARAFFIN_ID":HOTWASH_PARAFFIN_ID},
									success : function(data) { 
											if (data != null && typeof(data)!="undefined"){
													var outData = eval('(' + data + ')');
													if(outData.ERRCODE != null && typeof(outData.ERRCODE)!="undefined"){
        	...
        	//用户选择修改数据
					...
					if (rowdata.P_DESCRIPTION != null && typeof(rowdata.P_DESCRIPTION)!="undefined"){
					 ...
					 if (rowdata.HOT_WASH_TYPE != null && typeof(rowdata.HOT_WASH_TYPE)!="undefined"){
						 HOT_WASH_TYPE = rowdata.HOT_WASH_TYPE ; 
					 }else{
						 HOT_WASH_TYPE = "";
					 }
					 if (rowdata.WHTYPE != null && typeof(rowdata.WHTYPE)!="undefined"){
						 WHTYPE = rowdata.WHTYPE; 
					 }else{
						 WHTYPE = "";
					 }
					 if (rowdata.XRFSWH != null && typeof(rowdata.XRFSWH)!="undefined"){
						 XRFSWH = rowdata.XRFSWH; 
					 }else{
						 XRFSWH = "";
					 }
					 if (rowdata.PARAFFIN_MELT_TEMP != null && typeof(rowdata.PARAFFIN_MELT_TEMP)!="undefined"){
						 PARAFFIN_MELT_TEMP = rowdata.PARAFFIN_MELT_TEMP ; 
					 }else{
						 PARAFFIN_MELT_TEMP = "";
					 }
					
					 if (rowdata.PARAFFIN_MELT_VOL != null && typeof(rowdata.PARAFFIN_MELT_VOL)!="undefined"){
						 PARAFFIN_MELT_VOL = rowdata.PARAFFIN_MELT_VOL ; 
					 }else{
						 PARAFFIN_MELT_VOL = "";
					 }
					...
					HOTWASH_PARAFFIN_ID = rowdata.HOTWASH_PARAFFIN_ID ;			
                	if(operate == 2){
                		assignM(2);
                	}
      ...
      function assignM(flg){
			 ...
			 if(flg == 2){
				 	...
				 	$("#HOT_WASH_TYPE").ligerGetComboBoxManager().selectValue(HOT_WASH_TYPE);
				   	//document.getElementById("HOT_WASH_TYPE").value = HOT_WASH_TYPE;
	               	document.getElementById("PARAFFIN_MELT_TEMP").value = PARAFFIN_MELT_TEMP;
			 		document.getElementById("PARAFFIN_MELT_VOL").value = PARAFFIN_MELT_VOL;
					...
					document.getElementById("event_date").value = "";
			 		...
			 		$("#HOT_WASH_TYPE").ligerGetComboBoxManager().selectValue("");
			 		 //document.getElementById("HOT_WASH_TYPE").value = "";
	               	document.getElementById("PARAFFIN_MELT_TEMP").value = "";
			 		document.getElementById("PARAFFIN_MELT_VOL").value = "";
              	    		...
              	    		alert('请选择一条你要删除的数据！');
              	     		...
              	     		$.ligerDialog.confirm('确定删除吗?', function (yes) {
	              	     		 if(yes){
			                          jQuery.ajax({
											type : 'post',
											url : 'rxqlwh_removeData.action',
											async : false,
											data: {"HOTWASH_PARAFFIN_ID":HOTWASH_PARAFFIN_ID,"well_name":WELLNAME},
											success : function(data) { 
												if (data != null && typeof(data)!="undefined"){
													var outData = eval('(' + data + ')');
													if(outData.ERRCODE != null && typeof(outData.ERRCODE)!="undefined"){
      ...
      function onExport() {
		...
		var totalNum = 0;
		var url = "rxqlwh_searchDatas.action?CYZ="+encodeURIComponent(CYZ)+"&TEAM="+encodeURIComponent(TEAM)+"&WELLNAME="+encodeURIComponent(WELLNAME)+"&txtDate="+encodeURIComponent(txtDate)+'&txtDate1='+encodeURIComponent(txtDate1)+'&totalNum=export';
		var urls = "rxqlwh_searchDatas.action?CYZ="+encodeURIComponent(CYZ)+"&TEAM="+encodeURIComponent(TEAM)+"&WELLNAME="+encodeURIComponent(WELLNAME)+"&txtDate="+encodeURIComponent(txtDate)+'&txtDate1='+encodeURIComponent(txtDate1)+'&totalNum=totalNum';
		$.ajax({
			type : 'post',
			url : urls,
			async : false,
		   ...
		   <div id="edituser" style="width:100%;height: 100px; display:none;">
		        ...
		        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0">
		            <tr>
		                ...
		                <td align="left" class="l-table-edit-td" style="width:150px">热洗方式:</td>
		                <td align="left" class="l-table-edit-td" style="width:150px">溶蜡液温度:</td>
		                ...
		                <tr>
		                 ...
		                 <td align="left" class="l-table-edit-td" >
		                	<input name="event_date" type="text" id="event_date" ltype="text"  validate="{required:true,minlength:1,maxlength:20}" />
		                </td>
		                <td align="left" class="l-table-edit-td" >
		                	<input name="paraffin_stim_type" type="text" id="paraffin_stim_type"  ltype="text" validate="{required:true,minlength:1}" />
		                </td>
		                <td align="left" class="l-table-edit-td" >
		                	<input name="HOT_WASH_TYPE" type="text" id="HOT_WASH_TYPE" ltype="text"  />
		                </td>
		                
		            	<td align="left" class="l-table-edit-td" >
		                	<input name="PARAFFIN_MELT_TEMP" type="text" id="PARAFFIN_MELT_TEMP" ltype="text" />
		                </td>
		                
		                <td align="left" class="l-table-edit-td" >
		                	<input name="PARAFFIN_MELT_VOL" type="text" id="PARAFFIN_MELT_VOL" ltype="text" />
		                </td>
