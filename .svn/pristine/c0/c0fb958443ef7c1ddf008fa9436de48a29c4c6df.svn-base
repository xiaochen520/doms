...
/**
 * PcRpdWaterfloodingWellT entity. @author MyEclipse Persistence Tools
 */

public class PcRpdWaterfloodingWellT implements java.io.Serializable {
	...
	/** default constructor */
	public PcRpdWaterfloodingWellT() {
	}

	/** minimal constructor */
	public PcRpdWaterfloodingWellT(String orgId) {
		this.orgId = orgId;
	}

	/** full constructor */
	public PcRpdWaterfloodingWellT(String orgId, Date reportDate,
			...
			java.math.BigDecimal jk, java.math.BigDecimal pzl, java.math.BigDecimal rzl, byte liquidFlag,String remark, String wellName,
