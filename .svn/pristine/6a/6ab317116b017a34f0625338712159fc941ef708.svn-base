...
/**
 * PcRpdWaterfloodingWellbT entity. @author MyEclipse Persistence Tools
 */

public class PcRpdWaterfloodingWellbT implements java.io.Serializable {

	// Fields

	private String wellrpdid;
	...
	/** default constructor */
	public PcRpdWaterfloodingWellbT() {
	}

	/** minimal constructor */
	public PcRpdWaterfloodingWellbT(String orgId) {
		this.orgId = orgId;
	}

	/** full constructor */
	public PcRpdWaterfloodingWellbT(String orgId,
			Date reportDate, java.math.BigDecimal zqzwater, java.math.BigDecimal pqjby, java.math.BigDecimal jkyy,
			java.math.BigDecimal ty, java.math.BigDecimal pqj, java.math.BigDecimal jk, java.math.BigDecimal pzl, java.math.BigDecimal rzl,
			byte liquidFlag,String remark, String wellName, String classCheckOper,
			Date classCheckDate, String geologyCheckOper,
			Date geologyCheckDate, String rlastOper, Date rlastOdate) {
		this.orgId = orgId;
	...
	public String getWellrpdid() {
		return this.wellrpdid;
	}

	public void setWellrpdid(String wellrpdid) {
		this.wellrpdid = wellrpdid;
	}
