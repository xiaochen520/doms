...
public interface TytyxrbService {

	public JSONArray searchDatas(String txtDate,String sclz,String sbbh)throws Exception;
	...
	public List<Object[]> searchExportDatas(String txtDate, String fields)throws Exception;
