...
/**
 * PcRpdMeasurebT entity. @author MyEclipse Persistence Tools
 */

public class PcRpdMeasurebT implements java.io.Serializable {
	...
	/** default constructor */
	public PcRpdMeasurebT() {
	}

	/** minimal constructor */
	public PcRpdMeasurebT(String orgId, String wellname) {
		this.orgId = orgId;
		this.wellname = wellname;
	}

	/** full constructor */
	public PcRpdMeasurebT(String orgId, String wellname, Date startDatetime,
