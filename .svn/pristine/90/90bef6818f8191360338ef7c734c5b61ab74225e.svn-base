...
public class StationTDaoImpl extends HibernateDaoSupport implements StationTDao,Serializable{
	/**
	 * 
	 */
	...
	public List<Object[]> queryStationBasicInfo(final String boilersInfo,final int start, final int pagesize) {
...
//添加
	...
	public List<PcCdStationT> searchStations(String hql) throws Exception {
		List<PcCdStationT> stations = null;
		
		stations = (List<PcCdStationT>)this.getHibernateTemplate().find(hql);
		
		return stations;
	}

	public List<PcCdStationT> searchblockstationName(String hql)throws Exception {
		List<PcCdStationT> stations1 = null;
		
		stations1 = (List<PcCdStationT>)this.getHibernateTemplate().find(hql);
