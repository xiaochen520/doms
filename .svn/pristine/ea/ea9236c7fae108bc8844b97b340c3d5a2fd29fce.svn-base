...
<head><title>稀油注输联合站（水区）动态数据</title>
    ...
    <script type="text/javascript">
   	...
   	var grid;
		...
		function onExport() {
			...
			var totalNum = 0;
			var url = 'xysqdt_searchProducedRD.action?oilstationname='+encodeURIComponent(oilstationname)+'&areablock='+encodeURIComponent(areablock)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('export')+encodeURIComponent(blockstationname)+'&ghname='+encodeURIComponent(gh);
			var urls = 'xysqdt_searchProducedRD.action?oilstationname='+encodeURIComponent(oilstationname)+'&areablock='+encodeURIComponent(areablock)+'&date='+encodeURIComponent(txtDate)+'&date1='+encodeURIComponent(txtDate1)+'&totalNum='+encodeURIComponent('totalNum')+'&blockstationname='+encodeURIComponent(blockstationname)+'&ghname='+encodeURIComponent(gh);
			$.ajax({
				type : 'post',
				url : urls,
				async : false,
