...
<head><title>数据通断检查统计表</title>
    ...
    <script type="text/javascript">
         ...
         function onSubmit()
        {
        	grid.setOptions({
        		parms: [
                		{name: 'OBJECT_TYPE_NAME',value: $("#OBJECT_TYPE_NAME").val()},
      ...
      function onExport() {
		...
		var totalNum = 0;
		var url = "sjtdjctjb_searchDatas.action?OBJECT_TYPE_NAME="+encodeURIComponent(OBJECT_TYPE_NAME)+"&CHECK_DATE="+encodeURIComponent(CHECK_DATE)
												+'&totalNum=export';
		var urls = "sjtdjctjb_searchDatas.action?OBJECT_TYPE_NAME="+encodeURIComponent(OBJECT_TYPE_NAME)+"&CHECK_DATE="+encodeURIComponent(CHECK_DATE)
												+'&totalNum=totalNum';
		$.ajax({
			type : 'post',
			url : urls,
