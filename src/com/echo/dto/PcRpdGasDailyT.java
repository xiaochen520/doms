...
/**
 * PcRpdGasDailyT entity. @author MyEclipse Persistence Tools
 */

public class PcRpdGasDailyT implements java.io.Serializable {
	...
	/** default constructor */
	public PcRpdGasDailyT() {
	}

	/** minimal constructor */
	public PcRpdGasDailyT(String orgId) {
		this.orgId = orgId;
	}

	/** full constructor */
	public PcRpdGasDailyT(String orgId, String wellName, Date reportDate,
