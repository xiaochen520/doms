...
public class StationRPDDaoImpl extends HibernateDaoSupport implements StationRPDDao,Serializable{
	...
	public List<Object[]> searchData(final String boilersInfo,final String[] cloumnsName,final int start, final int pagesize) {
		List<Object[]> resultList = this.getHibernateTemplate()
		 .executeFind(new HibernateCallback() {

//			 String[] cloumnsName = {"CNAME","ZNAME","WELL_NAME","well_code","CJSJ","WATER_SOURCE_WELLRID","WATER_SOURCE_WELLID","INSTANTANEOUS_DELIVERY","LIQUID_LEVEL","PRES","CURRENTA","CURRENTB","CURRENTC",
